  ...
  return (
    <>
      ...
      <header className="nav shell" id="top">
        ...
        <a className="btn primary navCta" href={bookingUrl} target="_blank" rel="noreferrer">Agendar <span aria-hidden="true">↗</span></a>
      </header>
      <main id="conteudo">
        <section className="hero shell" aria-labelledby="hero-title">
          <div className="heroCopy">
            ...
            <div className="heroActions">
              <a className="btn primary" href={bookingUrl} target="_blank" rel="noreferrer">Agendar horário <span aria-hidden="true">↗</span></a>
              <a className="textLink" href="#tratamentos">Conhecer os cuidados <span aria-hidden="true">↓</span></a>
            </div>
        ...
        <section id="tratamentos" className="section shell">
          ...
          <div className="treatmentGrid">
            {treatments.map(t => <article className="treatmentCard" key={t.title}>
              ...
              <div className="treatmentCopy"><p className="eyebrow">{t.category}</p><h3>{t.title}</h3><a className="textLink" href={'#' + t.target}>Ver serviços <span aria-hidden="true">↗</span><span className="srOnly"> de {t.category}</span></a></div>
            </article>)}
          </div>
        </section>
        ...
        <section id="experiencia" className="experience">
          <div className="shell experienceGrid">
            ...
            <div className="experienceCopy"><p className="eyebrow">A experiência Bellez</p><h2>O cuidado começa no acolhimento.</h2><p>Da recepção ao atendimento, um momento dedicado a você. A Bellez reúne estética facial e corporal, massoterapia e diferentes áreas de bem-estar em Cangaíba.</p><a className="btn outlineLight" href="#contato">Conheça o espaço <span aria-hidden="true">↗</span></a></div>
          </div>
        </section>
        ...
        <section id="catalogo" className="section shell">
          ...
          <div className="catalogAction"><a className="btn primary" href={bookingUrl} target="_blank" rel="noreferrer">Consultar agenda <span aria-hidden="true">↗</span></a></div>
        </section>
        ...
        <section id="contato" className="contactSection">
          <div className="shell contactGrid"><div><p className="eyebrow">Venha conhecer</p><h2>Seu próximo momento de cuidado.</h2><p>Estamos em Cangaíba, na Zona Leste de São Paulo.</p></div><div className="contactInfo">
            <div><span>Endereço</span><a href="https://www.google.com/maps/search/?api=1&query=Bellez+Est%C3%A9tica+Integrativa+Av.+Canga%C3%ADba+3020+S%C3%A3o+Paulo" target="_blank" rel="noreferrer">Av. Cangaíba, 3020<br/>São Paulo — SP <span aria-hidden="true">↗</span></a></div>
            <div><span>Telefone</span><a href="tel:+5511958342872">(11) 95834-2872</a></div>
            <div><span>Agendamento</span><a href={bookingUrl} target="_blank" rel="noreferrer">Ver horários no Trinks <span aria-hidden="true">↗</span></a></div>
          </div></div>
        </section>
        <section className="finalCta shell"><div><p className="eyebrow">Seu momento Bellez</p><h2>Reserve um tempo para você.</h2></div><a className="btn primary" href={bookingUrl} target="_blank" rel="noreferrer">Agendar na Bellez <span aria-hidden="true">↗</span></a></section>
      </main>
